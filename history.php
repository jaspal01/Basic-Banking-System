...
<class class="welcome">
        <h2>
            <img src="logos/trans2.jpg" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Transaction History</strong> <img
                src="logos/trans3.png" alt="Bank" width="75" height="75">
        </h2>
    </class>
