...
#dataput td, #dataput th {
  border: 1px solid #ddd;
  padding: 8px;
}

#dataput tr:nth-child(even){background-color: #f2f2f2;}

#dataput tr:hover {background-color: #ddd;}
...
<body>
    ...
    <class class="welcome">
        <h2>
            <img src="logos/trans.jpg" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Money
                Transfer</strong> <img src="logos/mtran.jpg" alt="Bank" width="75" height="75">
        </h2>
    </class>

    <!-- options -->
    <div class="d-grip gap-2 col-6 mx-auto text-center p-3 mb-2">
        <a href="history.php"><button type="button" class="btn btn-danger btn-lg mb-3">See all Transaction History</button></a>
    </div>
    </div>
